    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="copyright">
                ...
                <p>All rights reserved &copy; Jamuna Safety and Security Services Limited. Designed and Developed by
                    <a href="https://theantopolis.com/" style="font-size: inherit; color: inherit;">Antopolis</a>
                </p>
            </div>
        </div>
    </div>
