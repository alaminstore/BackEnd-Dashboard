                ...
                <table id="socialMedia" class="table w-100 table-striped dataTable no-footer" role="grid" aria-describedby="data-table-4_info" style="width: 1098px;">
                    ...
                    <tbody id="loadnow">
                        ...
                        <tr class="item{{$founder->founder_speech_id}}" role="row">
                            ...
                            <td class="text-center">{{ \Illuminate\Support\Str::limit($founder->description, 30, $end='...') }}</td>
     ...
     <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <div class="form-group row flex_css">
                ...
                <div class="col-sm-9">
                    <textarea name="description" class="form-control" id="" cols="30" rows="10" placeholder="Description Here..."></textarea>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row flex_css">
                    <label for="name" class="col-sm-3 col-form-label">Description</label>
                    <div class="col-sm-9">
                        <textarea name="description" class="form-control" id="description" cols="30" rows="10" placeholder="Description Here..."></textarea>
                    </div>
                </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.success === true) {
                                    ...
                                    $('#socialMedia').DataTable().row('.item' + response.data.founder_speech_id).remove()
                                    .draw()
                                }
                                $("#loadnow").load(location.href + " #loadnow>*", "");
