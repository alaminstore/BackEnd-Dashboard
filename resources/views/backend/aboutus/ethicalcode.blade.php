        ...
        <div class="ms-panel">
          <div class="ms-panel-body">
            <div class="addnewdata">
                <button type="button" class="btn btn-sm btn-pill btn-dark has-icon clientBtn" title="Add" data-toggle="modal" data-target="#myModalSave"><i class="fa fa-plus"></i> Ethical Code</button>
            </div>
                ...
                <table id="socialMedia" class="table w-100 table-striped dataTable no-footer" role="grid" aria-describedby="data-table-4_info" style="width: 1098px;">
                    ...
                    <tbody id="loadnow">
                        ...
                        <tr role="row" class="item{{$ethical->ethical_code_id}}">
                            ...
                            <td class="text-center">{!! \Illuminate\Support\Str::limit($ethical->ethical_code_description, 30, $end='...') !!}</td>
     ...
     <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <div class="form-group row flex_css">
                ...
                <div class="col-sm-9">
                    <textarea name="ethical_code_description" class="form-control" id="" cols="30" rows="10" placeholder="Description Here..."></textarea>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row flex_css">
                    <label for="name" class="col-sm-3 col-form-label">Description</label>
                    <div class="col-sm-9">
                        <textarea name="ethical_code_description" class="form-control" id="ethical_code_description" cols="30" rows="10" placeholder="Description Here..."></textarea>
                    </div>
                </div>
        ...
        $('#reload-category').on('click', '.media-edit', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#ethical_code_description').val(response.data.ethical_code_description);
        ...
        $('#mediaStore').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    "" + response.data.ethical_code_description + "",
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.success === true) {
                                    ...
                                    $('#socialMedia').DataTable().row('.item' + response.data.ethical_code_id).remove()
                                    .draw()
                                }
                                $("#loadnow").load(location.href + " #loadnow>*", "");
                            }
