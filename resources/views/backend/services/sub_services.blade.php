                ...
                <table id="socialMedia" class="table w-100 table-striped dataTable no-footer" role="grid" aria-describedby="data-table-4_info" style="width: 1098px;">
                    ...
                    <tbody id="loadnow">
                        ...
                        <tr class="item{{$sub->sub_service_id}}" role="row">
                            ...
                            <td class="text-center">{!! \Illuminate\Support\Str::limit($sub->sub_service_description, 30, $end='...') !!}</td>
         ...
         <div class="modal-body">
            ...
            <div class="form-group row flex_css">
             ...
             <div class="form-group row flex_css">
                ...
                <div class="col-sm-9">
                    <textarea name="sub_service_description" class="form-control" id="" cols="30" rows="10"></textarea>
                </div>
            </div>
        ...
        $('#reload-category').on('click', '.media-edit', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        tinymce.get("sub_service_description").setContent(response.data.sub_service_description);
        ...
        $('#mediaStore').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    "" + response.data.sub_service_description + "",
