        ...
        <div class="ms-panel">
          <div class="ms-panel-body">
            <div class="addnewdata">
                <button type="button" class="btn btn-sm btn-pill btn-dark has-icon clientBtn" title="Add" data-toggle="modal" data-target="#myModalSave"><i class="fa fa-plus"></i> Client</button>
            </div>
                ...
                <table id="socialMedia" class="table w-100 table-striped dataTable no-footer" role="grid" aria-describedby="data-table-4_info" style="width: 1098px;">
                    ...
                    <tbody id="loadnow">
                        ...
                        <tr class="item{{$client->client_id}}" role="row">
                            ...
                            <td class="text-center"><img src="{{asset($client->client_logo)}}" style="width: 45px; height: 45px;" /></td>
                            <td class="text-center">{!! \Illuminate\Support\Str::limit($client->client_description, 30, $end='...') !!}</td>
  ...
  <div class="modal-dialog">
     <div class="modal-content">
         <div class="modal-header">
             <div class="headCenter"><h5 class="modal-title mt-0" id="myModalLabel">Add New Client</h5></div>
         ...
         <div class="modal-body">
             ...
             <div id="clientSave">
                ...
                <div class="col-sm-9">
                    <select style="width:100%;" id="cat" class=" form-control cat_selector" name="client_category_id">
                        <option value="">Choose Category...</option>
                        @foreach($clientcat as $cat)
                            <option value="{{$cat->client_category_id}}">{{$cat->client_category_name}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="form-group row flex_css">
                ...
                <div class="col-sm-9">
                    <textarea   class="form-control" name="client_description"  cols="30" rows="10" placeholder="Description here..."></textarea>
                </div>
            </div>
             </div>
            <div class="form-group row flex_css">
...
<div id="myModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <div class="headCenter"><h5 class="modal-title mt-0" id="myModalLabel"> Client Info Update</h5></div>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group row flex_css">
                    <label for="name" class="col-sm-3 col-form-label">Client Category</label>
                    <div class="col-sm-9">
                        <select style="width:100%;" id="cat2" class="form-control cat_selector" name="client_category_id">
                            <option value="">Choose Category</option>
                            @foreach($clientcat as $cat)
                                <option value="{{$cat->client_category_id}}">{{$cat->client_category_name}}</option>
                            @endforeach
                ...
                <div class="form-group row flex_css">
                    <label for="name" class="col-sm-3 col-form-label">Client Description</label>
                    <div class="col-sm-9">
                        <textarea name="client_description" class="form-control" id="client_description"  cols="30" rows="10" placeholder="Description here..."></textarea>
                    </div>
                </div>
                <div class="form-group m-b-0">
                    <div>
...
<div id="viewModal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
 ...
 <div class="modal-dialog">
   <div class="modal-content">
       <div class="modal-header">
           <div class="headCenter"><h5 class="modal-title mt-0" id="myLargeModalLabel">Client Details</h5></div>
           <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
       </div>
            ...
            $('#reload-category').on('click', '.viewData', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#viewImage').html(`<img width="300" height="300" class="img-fluid"  src="${url}/${response.data.client_logo}"/>`);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(response.status == 0){
                        ...
                        '<img src="'+response.data.client_logo+'" style="width: 45px; height:45px;"/>',
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.success === true) {
                                    ...
                                    $('#socialMedia').DataTable().row('.item' + response.data.client_id).remove()
                                    .draw()
                                }
                            }
