                ...
                <table id="socialMedia" class="table w-100 table-striped dataTable no-footer" role="grid" aria-describedby="data-table-4_info" style="width: 1098px;">
                    ...
                    <tbody id="loadnow">
                        ...
                        <tr role="row" class="item{{$val->news_id}}">
                            ...
                            <td class="text-center">{{\Illuminate\Support\Str::limit($val->news_description , 30, $end='...') }}</td>
         ...
         <div class="modal-body">
            ...
            <div id="newsSave">
                ...
                <div class="form-group row flex_css">
                    ...
                    <div class="col-sm-9">
                        <textarea   class="form-control" name="news_description"  cols="30" rows="10" placeholder="Description here..." required></textarea>
                    </div>
                </div>
                <div class="form-group row flex_css">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row flex_css">
                    <label for="name" class="col-sm-3 col-form-label">Description</label>
                    <div class="col-sm-9">
                        <textarea  class="form-control" name="news_description" id="news_description"  cols="30" rows="10" placeholder="Description here..."></textarea>
                    </div>
                </div>
                <div class="form-group row flex_css">
                    <label for="name" class="col-sm-3 col-form-label">Published Date</label>
        ...
        $('#reload-category').on('click', '.media-edit', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#news_published_at').val(response.data.news_published_at);
            ...
            $('#reload-category').on('click', '.viewData', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#viewPublished').html(response.data.news_published_at);
        ...
        $('#mediaStore').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    "" + response.data.news_description + "",
